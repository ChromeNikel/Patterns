...
public class LeftUpAdapter implements Arrow{

    private Diagonal diagonal;
    private int [][] map;
    private final String arrowName = "ВлевоВниз";

    public LeftUpAdapter(Diagonal diagonal, int [][] map) {
