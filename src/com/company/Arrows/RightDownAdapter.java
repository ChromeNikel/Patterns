...
public class RightDownAdapter implements Arrow{

    private Diagonal diagonal;
    private int [][] map;
    private final String arrowName = "ВправоВниз";

    public RightDownAdapter(Diagonal diagonal, int [][] map) {
